...
public class LDADataset {
	...
	public Dictionary localDict;	// local dictionary，from zero
	...
	public Dictionary globalDict;	 		//global
	...
	public static LDADataset readDataSet(BufferedReader reader){
		try {
			...
			for (int i = 0; i < M; ++i){
				line = reader.readLine();						//每一行是一个doc(outputsplitline函数)
				data.setDoc(line, i);
			}
